                        ...
                        foreach ($statement->fetchAll() as $user_row) {
                            if ($user_row['user_status'] == 'Enable') {
                                ...
                                if ($total_book_issue < $book_issue_limit) {
                                    ...
                                    //Querry to insert new issued book.
                                    $query = "
...
<div class="container-fluid py-4" style="min-height: 700px;">
    ...
    ?>
            ...
            <ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
                ...
                <li class="breadcrumb-item"><a href="issue_book.php">Issued Book Management</a></li>
        ...
        <?php
            ...
            if ($issue_book_id > 0) {
                ...
                foreach ($result as $row) {
                    ...
                    $status = $row["book_issue_status"]; //returned or not returned.
        ...
        <ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Issued Book Management</li>
        </ol>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col col-md-6">
                        <i class="fas fa-table me-1"></i> Issued Book Management
                    </div>
                    ...
                    <tbody>
                        ...
                        if ($statement->rowCount() > 0) {
                            ...
                            foreach ($statement->fetchAll() as $row) {
                                ...
                                $book_name = "";
                                $query = "
                                    SELECT book_name FROM lms_book WHERE book_isbn_number =" . $row["book_id"];
                                $result = $connect->query($query);
                                foreach ($result as $roow) {
                                    $book_name = $roow["book_name"];
                                }

                                $user_name = "";
                                $query = "
                                    SELECT user_name FROM lms_user WHERE user_unique_id ='" . $row["user_id"] . "'";
                                $result = $connect->query($query);
                                foreach ($result as $roow) {
                                    $user_name = $roow["user_name"];
                                }
