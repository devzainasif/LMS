...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	//Show message for enable and disable message.
 	if(isset($_GET["msg"]))
 	{
 		if($_GET["msg"] == 'disable')
 		{
 		...
 		{
 			echo '
 			<div class="alert alert-success alert-dismissible fade show" role="alert">User Status Change to Enable <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
 			';
 		}
 	}
    			...
    			if($statement->rowCount() > 0)
    			{
    				foreach($statement->fetchAll() as $row)
    				{
    					...
    					<tr>
    						...
    						<td><button type="button" name="delete_button" class="btn btn-danger btn-sm" onclick="delete_data(`'.$row["user_id"].'`, `'.$row["user_status"].'`)">Enable/Disable</td>
    					</tr>
    					';
    				}
    			}
...
<script>
	...
	//this function is used for enabled and disabled user.
